...
if place == "forest":                      #added a =
    action = input("climb a tree or cross a river? ")
    if action == "climb a tree":           #added a =
        print("You found a bird's nest!")
    elif action == "cross a river":        #changed to elif and added a =, but could have left as else and removed condition.
        print("You found a boat!")
elif place == "cave":                      #added a =
